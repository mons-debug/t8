      ...
      <div className="mx-auto max-w-[1440px]">
        <div className="grid gap-16 md:grid-cols-[1fr_1.3fr]">
          ...
          >
            ...
            <p className="mt-6 max-w-[30ch] text-[15px] leading-[1.7] text-[#64748b] dark:text-[#94a3b8] dark:text-[#64748b]">
          ...
          <div className="grid grid-cols-2 gap-3">
            {ITEMS.map((item, i) => (
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className="rounded-[1.5rem] bg-white dark:bg-white/[0.04] p-6 ring-1 ring-black/[0.03] dark:ring-white/[0.06] transition-shadow duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.06)]"
              >
                <div className="flex h-11 w-11 items-center justify-center rounded-[0.875rem] bg-[#faf6f1] dark:bg-white/[0.06] ring-1 ring-black/[0.03] dark:ring-white/[0.06]">
                  <item.icon className="h-5 w-5 text-[#0a0a0f] dark:text-white" strokeWidth={1.5} />
                </div>
                <h3 className="mt-5 text-[14px] font-bold text-[#0a0a0f] dark:text-white">{item.title}</h3>
                <p className="mt-2 text-[12px] leading-[1.6] text-[#94a3b8] dark:text-[#64748b]">{item.body}</p>
              </motion.div>
            ))}
          </div>
        </div>
